...
import { fakeAsync, inject, TestBed, getTestBed, waitForAsync } from '@angular/core/testing';
...
describe('Routing', () => {
  ...
  it(`navigate to '' takes you to /signup-form`, waitForAsync(() => {
  ...
  it(`navigate to 'signup-details' takes you to /signup-details`, waitForAsync(() => {
    const fixture = TestBed.createComponent(RoutingComponent);
    fixture.detectChanges();
